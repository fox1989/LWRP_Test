Shader "Unlit/Bh3"
{
    Properties
    {
        ...
        [KeywordEnum(None,LightMap_R,LightMap_G,LightMap_B,UV,UV2,VertexColor,BaseColor)] _TestMode("_TestMode",Int) = 0
    }
...
/*==========================Texture ==========================*/
                ...
                float3 LightMap = tex2D(_LightMap,uv).rgb;
...
/*==========================Diffuse ==========================*/
                ...
                if(wrapLight +_DiffuseThreshold*0.1 <LightMap.g )
                {
